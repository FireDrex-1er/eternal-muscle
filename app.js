...
document.body.children["Bras"].addEventListener("click",function () {
    ...
    Exercice.innerHTML=`
        ...
        <br><br><span id="exercice_titre">Avant-Bras</span><br>
        <span id="exercie_exo">30 Répétition de 3 série</span> <a id="exercice_pause"> Pause 15s</a><br><br>
        ...
        <span id="exercice_titre">Bras</span><br>
        <span id="exercie_exo">30 Répétition de 3 série</span>     <a id="exercice_pause"> Pause 15s</a><br><br>
        <span id="exercie_nom">Curl Marteau block alterné </span>  <a id="info" href="https://www.youtube.com/watch?v=Br0PN91sHu0&t=223s">info</a><br>
        ...
        <span id="exercie_nom">Curl marteau pupitre</span>         <a id="info" href="https://www.youtube.com/watch?v=GNO4OtYoCYk">info</a><br><br>

        <span id="exercice_titre">Epaule</span><br>
        <span id="exercie_exo">30 Répétition de 3 série</span>     <a id="exercice_pause"> Pause 15s</a><br><br>
        <span id="exercie_nom">Elévation latérales </span>  <a id="info" href="https://www.youtube.com/watch?v=kfBYCQFVFBE">info</a><br>
        <span id="exercie_nom">Peck deck inversé </span>  <a id="info" href="https://www.youtube.com/watch?v=kfBYCQFVFBE">info</a><br>
        <span id="exercie_nom">... </span>                 <a id="info" href="...">info</a><br>
