...
document.body.children["head"].children[2].addEventListener('click', function() {
    ...
    window.location.href = 'https://eternal-musculation.netlify.app/Epaule/video_PompePiquees.html';
});document.body.children["menu"].children[2].addEventListener('click', function() {
    window.location.href = 'https://eternal-musculation.netlify.app/Epaule/video_LateralRaise.html';
});